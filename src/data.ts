...
export const processData: ProcessDataItem[] = [
	{
		...
		title: "Online order",
		description:
			"Seamlessly place your food orders online with our intuitive platform, making mealtime a breeze.",
	},

	{
		...
		description:
			"Experience lightning-fast delivery times that ensure your favorite dishes reach your doorstep in record time.",
	},

	{
		icon: React.createElement(LiaStar),
		title: "Best taste",
		description:
			"Indulge your taste buds with a curated selection of dishes crafted to perfection, guaranteeing the best flavors in every bite.",
	},
];
